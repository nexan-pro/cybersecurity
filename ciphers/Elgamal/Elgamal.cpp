 ...
 */
ulong32_t CElgamal::genRandPrime() {
  ulong32_t nRand = rand() % 999'999 + 2;
  while (!isPrime(nRand))
    nRand = rand() % 999'999 + 2;
 ...
 */
bool CElgamal::isPrime(ulong32_t nP) {
 ...
 */
bool* CElgamal::sieveOfEratosthenes(ulong32_t n) {
 ...
 */
cpp_int_t* CElgamal::getPrimeSequence(ulong32_t n) {
